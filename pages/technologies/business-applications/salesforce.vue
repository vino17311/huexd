    ...
    <section class="py-4">
        ...
        <section class="container mx-auto mt-4 mb-4">
            <div class="section_one_img_container">
                <img class="section_one_img"
                    src="https://thumbor.forbes.com/thumbor/fit-in/900x510/https://www.forbes.com/advisor/wp-content/uploads/2022/09/consultant.jpeg.jpg"
                    alt="Landscape Image">
            </div>
        </section>
        ...
        <div class="container c-hero__breadcrumb">
            <nav aria-label="breadcrumb" class="overflow-x-auto">
                <ol class="flex	c-breadcrumb whitespace-nowrap forced-color-adjust-auto">
                    ...
                    <li class="c-breadcrumb__item --current">salesforce</li>
                </ol>
            </nav>
        </div>
    </section>
    ...
    <section>
        <div class="container row">
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 order-sm-1 order-md-1">
                ...
                <p dir="ltr"><b>
                        Hiring Salesforce superstars is key to understanding your customer. Reacting to their behaviour.
                        Strategic shaping to give them a better experience. To increase revenue. Spark growth. Evolve.
                    </b></p>
                    ...
                    <ul class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                        ...
                        <li class="c-panels__item">
                            <div class="c-panels__item-head">
                                <h4 class="c-panels__item-title">Sales Cloud
                                </h4>
                            </div>
                        ...
                        <li class="c-panels__item">
                            <div class="c-panels__item-head">
                                <h4 class="c-panels__item-title">Communities Cloud
                                </h4>
                            </div>
                        ...
                        <li class="c-panels__item">
                            <div class="c-panels__item-head">
                                <h4 class="c-panels__item-title">Platform & Ecosystem
                                </h4>
                            </div>
                        ...
                        <li class="c-panels__item">
                            <div class="c-panels__item-head">
                                <h4 class="c-panels__item-title">Collaboration
                                </h4>
                            </div>
                        ...
                        <li class="c-panels__item">
                            <div class="c-panels__item-head">
                                <h4 class="c-panels__item-title">Commerce Cloud
                                </h4>
                            </div>
                        ...
                        <li class="c-panels__item">
                            <div class="c-panels__item-head">
                                <h4 class="c-panels__item-title">Industries
                                </h4>
                            </div>
                        ...
                        <li class="c-panels__item">
                            <div class="c-panels__item-head">
                                <h4 class="c-panels__item-title">Mulesoft
                                </h4>
                            </div>

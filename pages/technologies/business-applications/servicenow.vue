    ...
    <section class="py-4">
        <div class="container hero4__top">
            <h2 class="flex flex-col	 hero__first__heading text-4xl md:text-6xl lg:text-6xl xl:text-6xl">
                <span class="block md:inline">Recruiters who</span>
                <span class="block md:inline">saw Service&nbsp;Now</span>
                <span class="block md:inline">coming.</span>
            </h2>
        </div>

        <div class="container hero__technologies">
            <p class="hero__second__heading">We’ve been building our ServiceNow talent pipeline for years. Access it
                now.</p>
        </div>
        ...
        <section class="container mx-auto mt-4 mb-4">
            <div class="section_one_img_container">
                <img class="section_one_img"
                    src="https://www.royalcyber.com/wp-content/uploads/2023/08/servicenow-grc-main-banner.jpg"
                    alt="Landscape Image">
            </div>
        </section>
        ...
        <div class="container c-hero__breadcrumb">
            <nav aria-label="breadcrumb" class="overflow-x-auto">
                <ol class="flex	c-breadcrumb  whitespace-nowrap">
                    ...
                    <li class="c-breadcrumb__item --current">service now</li>
                </ol>
            </nav>
        </div>
    </section>
        ...
        <div class="container row">
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12 order-sm-1 order-md-1">
                <h2 class="mb-5 text-2xl md:text-6xl lg:text-6xl xl:text-4xl">
                    <span class="block md:inline">Service Now candidates. Ready&nbsp;</span>
                    <span class="block md:inline">for your call.</span>
                </h2>
                <p dir="ltr">HUEXD recruiters have been nurturing our ServiceNow talent pipeline since before it was
                    “cool.” With strong ties in the tech recruitment industry. And a deep knowledge of business
                    applications. We saw ServiceNow’s popularity coming. So we got to work. </p>
                <p>Now, you can benefit from our global ServiceNow reach. And rich expertise in this up and coming
                    business application. To streamline your business processes. Increase efficiency. And win big in a
                    fast-moving world. &nbsp;</p>
                <p>Our recruitment specialists have relationships with strong SNOW candidates. And can help you build a
                    team quickly. From ServiceNow software developers to architects, we’ll help you transition to SNOW
                    ...
                    <ul class="grid grid-cols-1 sm:grid-cols-3 gap-3">
                        ...
                        <li class="c-panels__item">
                            <div class="c-panels__item-head">
                                <h4 class="c-panels__item-title">ServiceNow ITSM
                                </h4>
                            </div>
                        ...
                        <li class="c-panels__item">
                            <div class="c-panels__item-head">
                                <h4 class="c-panels__item-title">ServiceNow ITOM
                                </h4>
                            </div>
                        ...
                        <li class="c-panels__item">
                            <div class="c-panels__item-head">
                                <h4 class="c-panels__item-title">ServiceNow WSD
                                </h4>
                            </div>
                        ...
                        <li class="c-panels__item">
                            <div class="c-panels__item-head">
                                <h4 class="c-panels__item-title">ServiceNow APP
                                </h4>
                            </div>
                            ...
                            <div class="c-accordion">
                                <ul class=" flex flex-col gap-4	 c-accordion-items js-accordion">
                                    <li class="c-accordion-item  bg-gray-200 ">
                                        <h5 class="c-accordion-item-title  font-bold">ServiceNow Software Developers
                                        </h5>
                                    </li>
                                    <li class="c-accordion-item bg-gray-200 ">
                                        <h5 class="c-accordion-item-title   font-bold">ServiceNow Architects
                                        </h5>
                                    </li>
                                    <li class="c-accordion-item  bg-gray-200 ">
                                        <h5 class="c-accordion-item-title   font-bold">ServiceNow Solutions Architects
                                        </h5>
                                    </li>
                                    <li class="c-accordion-item  bg-gray-200 ">

...
export const ContactvalidationSchema = z.object({
  firstName: z
    ...
    .regex(/^[A-Za-z]+$/, { message: "Enter characters only" })
  ...
  // phone: z
  //   .string()
  //   .regex(/^\d{10}$/, { message: "Phone number should be 10 digits long" })
  //   .optional(),
  ...
  message: z
    .string()
    .min(20, { message: "Message should be at least 50 characters long" })
